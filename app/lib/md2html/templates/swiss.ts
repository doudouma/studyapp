...
export const swiss: MdTemplate = {
  ...
  variants: [
    {
      swatch: ["#fafaf8", "#002FA7", "#0a0a0a"],
      css: `
        .md-body { color: #0a0a0a; background: #fafaf8; font-family: "Inter Tight", "Inter", "Noto Sans SC", system-ui, sans-serif; line-height: 1.6; -webkit-font-smoothing: antialiased; }
        .md-body h1, .md-body h2, .md-body h3 { color: #0a0a0a; font-weight: 900; line-height: 1.05; letter-spacing: -0.02em; }
        .md-body h1 { font-size: 2.4em; }
        .md-body h1::after { content: ""; display: block; width: 60px; height: 6px; background: #002FA7; margin-top: 0.4em; }
        .md-body h2 { font-size: 1.7em; }
        .md-body h3 { font-size: 1.2em; color: #002FA7; }
        .md-body a { color: #002FA7; font-weight: 700; text-decoration: none; border-bottom: 2px solid #002FA7; }
        .md-body a:hover { border-bottom-color: #0a0a0a; color: #0a0a0a; }
        .md-body strong { color: #002FA7; font-weight: 800; text-decoration: underline; text-decoration-thickness: 2px; text-decoration-color: #002FA7; text-underline-offset: 3px; }
        .md-body blockquote { border-left: 4px solid #002FA7; background: #eef2ff; margin: 1.4em 0; padding: 0.8em 1.2em; color: #4a4a4a; }
        .md-body code { background: #fafaf8; color: #0a0a0a; border: 1px solid #0a0a0a; padding: 0.12em 0.4em; border-radius: 2px; font-family: "JetBrains Mono", ui-monospace, monospace; font-size: 0.88em; }
        .md-body pre { background: #fafaf8; border: 1px solid #0a0a0a; border-radius: 4px; padding: 1em; overflow-x: auto; }
        .md-body pre code { background: none; color: #0a0a0a; border: none; padding: 0; }
        .md-body table { border-collapse: collapse; width: 100%; }
        .md-body th, .md-body td { border-bottom: 1px solid rgba(10, 10, 10, 0.5); padding: 0.5em 0.8em; text-align: left; }
        .md-body th { border-bottom: 3px solid #002FA7; font-weight: 800; color: #002FA7; background: #eef2ff; }
        .md-body hr { border: none; border-top: 2px solid #0a0a0a; margin: 2.2em 0; }
        .md-body img { max-width: 100%; }
        .md-body blockquote p { margin: 0.3em 0; }
        .md-body li::marker { color: #002FA7; }
        .hljs { background: transparent; }
      `,
    },
  ],
