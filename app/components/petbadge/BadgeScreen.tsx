...
import { BadgeClip, RadarSVG, BarcodeSVG, THEME_CARD, THEME_KEYS, RLBL_KEYS, rnd, todayStr, type Theme } from "./helpers";
...
export function BadgeScreen({
  ...
  return (
    <div className="min-h-dvh transition-colors duration-500">
        ...
        <div className="mt-[30px] grid grid-cols-3 gap-[11px] w-[min(352px,100%)]">
          {THEME_KEYS.map(([key, labelKey]) => (
            <Button
              ...
              className={`font-extrabold text-[15px] rounded-full py-[13px] px-1 transition-all active:scale-[.95] whitespace-nowrap ${
                theme === key
